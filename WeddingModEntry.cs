...
namespace WeddingTweaks
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        public static string dictionaryKey = "ApryllForever.PolyamorySweetWedding/dictionary";
        public static string witnessKey = "ApryllForever.PolyamorySweetWedding/witnessName";
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            // The original. Ambiguous error. I think it only applies to getting children at the wedding event.
            //
           // harmony.Patch(  
        ...
        public void GameLoop_GameLaunched(object sender, GameLaunchedEventArgs e)
        {
            try
            {
                polyamorySweetLoveAPI = Helper.ModRegistry.GetApi< IPolyamorySweetLoveAPI > ("ApryllForever.PolyamorySweetLove");
            }
            catch { }

            if (polyamorySweetLoveAPI != null)
            {
                Monitor.Log("PolyamorySweetLove API loaded");
            }
